...
#define USART_FLAG_IDLE			( 1 << USART_SR_IDLE )	//OK
#define USART_FLAG_RXNE			( 1 << USART_SR_RXNE )	//OK
#define USART_FLAG_TC			( 1 << USART_SR_TC )	//OK
#define USART_FLAG_TXE			( 1 << USART_SR_TXE )	//OK
#define USART_FLAG_LBD			( 1 << USART_SR_LBD )
#define USART_FLAG_CTS			( 1 << USART_SR_CTS )	//OK
